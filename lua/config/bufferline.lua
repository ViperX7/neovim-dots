...
bufferline.setup {
  options = {
    ...
    offsets = {
      ...
      { filetype = "DiffviewFiles", text = "󰆏  Diff Viewer",       text_align = "left" --[[| "center" | "right" --]] },
    },
    ...
    -- end, -- 'insert_after_current' |'insert_at_end' | 'id' | 'extension' | 'relative_directory' | 'directory' | 'tabs' |
  }
}
